...
\File{.\,.\1src\1examples\1examples\_frame\1calibrateF.c},{14:00},{Jun 26 1998}
...
\L{\LB{___\K{int}_\V{i},\V{j},\V{code},\V{npoint},\V{ir},\V{ii},\V{reset}=0,\V{pass}=0;}}
...
\L{\LB{}}
\L{\LB{___\C{}\1\* set up channel name \*\1\CE{}}}
\L{\LB{___\V{fgetinput}.\V{chnames}[0]=\S{}\"IFO\_DMRO\"\SE{};}}
\L{\LB{}}
\L{\LB{___\C{}\1\* set up channel names for different cases \*\1\CE{}}}
...
\L{\LB{}}
\L{\LB{___\C{}\1\* we do need the data, so don\'t seek \*\1\CE{}}}
\L{\LB{___\V{fgetinput}.\V{seek}=0;}}
\L{\LB{}}
\L{\LB{___\C{}\1\* do need calibration information \*\1\CE{}}}
\L{\LB{___\V{fgetinput}.\V{calibrate}=1;}}
\L{\LB{}}
\L{\LB{___\C{}\1\* where to put the data points \*\1\CE{}}}
...
\L{\LB{___\K{while}_((\V{code}=\V{fget\_ch}(\&\V{fgetoutput},\&\V{fgetinput})))_\{}}
...
\L{\LB{}}
\L{\LB{______\C{}\1\* use the swept-sine calibration (properly interpolated) to get R(f) \*\1\CE{}}}
\L{\LB{______\K{if}_(!\V{pass}++)_\V{GRnormalize}(\V{fgetoutput}.\V{fri},\V{fgetoutput}.\V{frinum},\V{npoint},\V{srate},\V{response});}}
\L{\LB{}}
...
\L{\LB{_________\V{graphout}(0,\V{tstart},\V{tlock});}}
\L{\LB{______\}}}
\L{\LB{___\}}}
