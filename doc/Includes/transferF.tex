...
\File{.\,.\1src\1examples\1examples\_frame\1transferF.c},{13:53},{Jun 30 1999}
...
\L{\LB{___\K{short}_\K{int}_\V{data};}}
\L{\LB{}}
...
\L{\LB{}}
\L{\LB{___\C{}\1\* open frame, read one point, get calibration data, get response, and scale \*\1\CE{}}}
...
\L{\LB{___\V{fgetinput}.\V{npoint}=\V{fgetinput}.\V{seek}=\V{fgetinput}.\V{calibrate}=1;}}
\L{\LB{___\V{fgetinput}.\V{locations}[0]=\&\V{data};}}
\L{\LB{___\V{fget\_ch}(\&\V{fgetoutput},\&\V{fgetinput});}}
\L{\LB{___\V{GRnormalize}(\V{fgetoutput}.\V{fri},\V{fgetoutput}.\V{frinum},\V{NBINS},\V{srate},\V{response});}}
