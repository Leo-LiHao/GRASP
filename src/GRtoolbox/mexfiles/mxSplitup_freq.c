/* compile: mex -g -I/LIGO/GRASP/include mxSplitup_freq.c -L/LIGO/GRASP/lib -lgrasp -L/usr/local/lib -lrecipes_c	*/
/*															*/	
/* example run: 		 							                                */
/*															*/
/* Steve Drasco 													*/
...
{
	float	c0, c90, *chirp0, *chirp90, norm, *twice_inv_noise, *stats, *working, *htilde;
        ...
        if (nlhs != 4)
                mexErrMsgTxt("Need 4 outputs (indices, stats, working, htilde)");
	...
	/* call splitup_freq */        
	splitup_freq(c0, c90, chirp0, chirp90, norm, twice_inv_noise, n, offset, p, indices, stats, working, htilde);
